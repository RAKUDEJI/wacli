...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_random_bytes_cabi<T: Guest>(arg0: i32,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result0 = {
  T::random_bytes(arg0 as u32)
};
let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
let vec2 = <_ as Into<_rt::Vec<_>>>::into(result0).into_boxed_slice();
let ptr2 = vec2.as_ptr().cast::<u8>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_random_bytes<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base2 = l0;
  let len2 = l1;
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_insecure_random_bytes_cabi<T: Guest>(arg0: i32,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result0 = {
  T::insecure_random_bytes(arg0 as u32)
};
let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
let vec2 = <_ as Into<_rt::Vec<_>>>::into(result0).into_boxed_slice();
let ptr2 = vec2.as_ptr().cast::<u8>();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_insecure_random_bytes<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base2 = l0;
  let len2 = l1;
...
pub trait Guest {
  ...
  #[allow(async_fn_in_trait)]
  fn random_bytes(n: u32,) -> _rt::Vec::<u8>;
  #[allow(async_fn_in_trait)]
  fn insecure_random_bytes(n: u32,) -> _rt::Vec::<u8>;
  #[allow(async_fn_in_trait)]
...
macro_rules! __export_wacli_cli_host_1_0_0_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[unsafe(export_name = "wacli:cli/host@1.0.0#random-bytes")]
    unsafe extern "C" fn export_random_bytes(arg0: i32,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_random_bytes_cabi::<$ty>(arg0) }
    }
    #[unsafe(export_name = "cabi_post_wacli:cli/host@1.0.0#random-bytes")]
    unsafe extern "C" fn _post_return_random_bytes(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_random_bytes::<$ty>(arg0) }
    }
    #[unsafe(export_name = "wacli:cli/host@1.0.0#insecure-random-bytes")]
    unsafe extern "C" fn export_insecure_random_bytes(arg0: i32,) -> *mut u8 {
      unsafe { $($path_to_types)*::_export_insecure_random_bytes_cabi::<$ty>(arg0) }
    }
    #[unsafe(export_name = "cabi_post_wacli:cli/host@1.0.0#insecure-random-bytes")]
    unsafe extern "C" fn _post_return_insecure_random_bytes(arg0: *mut u8,) {
      unsafe { $($path_to_types)*::__post_return_insecure_random_bytes::<$ty>(arg0) }
    }
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6395] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf70\x01A\x02\x01A4\x01\
...
\x0c\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\
\0w\x04\0\x0eget-random-u64\x01\x02\x03\0\x18wasi:random/random@0.2.9\x05\x0d\x01\
...
.9\x05\x0e\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x0dinsecure-seed\x01\x01\x03\0\x1f\
wasi:random/insecure-seed@0.2.9\x05\x0f\x01B\x0a\x01o\x02ss\x01p\0\x01@\0\0\x01\x04\
...
\x05\x10\x01B\x03\x01j\0\0\x01@\x01\x06status\0\x01\0\x04\0\x04exit\x01\x01\x03\0\
\x13wasi:cli/exit@0.2.9\x05\x11\x01B\x05\x02\x03\x02\x01\x06\x04\0\x0cinput-stre\
am\x03\0\0\x01i\x01\x01@\0\0\x02\x04\0\x09get-stdin\x01\x03\x03\0\x14wasi:cli/st\
din@0.2.9\x05\x12\x01B\x05\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\0\x01\
i\x01\x01@\0\0\x02\x04\0\x0aget-stdout\x01\x03\x03\0\x15wasi:cli/stdout@0.2.9\x05\
\x13\x01B\x05\x02\x03\x02\x01\x07\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\0\
\0\x02\x04\0\x0aget-stderr\x01\x03\x03\0\x15wasi:cli/stderr@0.2.9\x05\x14\x01B\x01\
\x04\0\x0eterminal-input\x03\x01\x03\0\x1dwasi:cli/terminal-input@0.2.9\x05\x15\x01\
B\x01\x04\0\x0fterminal-output\x03\x01\x03\0\x1ewasi:cli/terminal-output@0.2.9\x05\
\x16\x02\x03\0\x0e\x0eterminal-input\x01B\x06\x02\x03\x02\x01\x17\x04\0\x0etermi\
nal-input\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x12get-terminal-stdin\x01\
\x04\x03\0\x1dwasi:cli/terminal-stdin@0.2.9\x05\x18\x02\x03\0\x0f\x0fterminal-ou\
tput\x01B\x06\x02\x03\x02\x01\x19\x04\0\x0fterminal-output\x03\0\0\x01i\x01\x01k\
\x02\x01@\0\0\x03\x04\0\x13get-terminal-stdout\x01\x04\x03\0\x1ewasi:cli/termina\
l-stdout@0.2.9\x05\x1a\x01B\x06\x02\x03\x02\x01\x19\x04\0\x0fterminal-output\x03\
\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stderr\x01\x04\x03\0\x1e\
wasi:cli/terminal-stderr@0.2.9\x05\x1b\x01B\x09\x01y\x04\0\x09exit-code\x03\0\0\x01\
ps\x01r\x08\x04names\x07summarys\x05usages\x07aliases\x02\x07versions\x06hidden\x7f\
\x0bdescriptions\x08examples\x02\x04\0\x0ccommand-meta\x03\0\x03\x01q\x04\x0funk\
nown-command\x01s\0\x0cinvalid-args\x01s\0\x06failed\x01s\0\x02io\x01s\0\x04\0\x0d\
command-error\x03\0\x05\x01j\x01\x01\x01\x06\x04\0\x0ecommand-result\x03\0\x07\x04\
\0\x15wacli:cli/types@1.0.0\x05\x1c\x02\x03\0\x13\x09exit-code\x01B\x1e\x02\x03\x02\
\x01\x1d\x04\0\x09exit-code\x03\0\0\x01ps\x01@\0\0\x02\x04\0\x04args\x01\x03\x01\
...
\x0e\x01@\x01\x01ny\0\x07\x04\0\x0crandom-bytes\x01\x0f\x04\0\x15insecure-random\
-bytes\x01\x0f\x01@\x01\x04code\x01\x01\0\x04\0\x04exit\x01\x10\x04\0\x14wacli:c\
li/host@1.0.0\x05\x1e\x04\0\x1dwacli:cli/host-provider@1.0.0\x04\0\x0b\x13\x01\0\
\x0dhost-provider\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compone\
nt\x070.244.0\x10wit-bindgen-rust\x060.52.0";
