                ...
                fn fmt(
                    ...
                    match self {
                        CommandError::UnknownCommand(e) => {
                            f.debug_tuple("CommandError::UnknownCommand")
                                .field(e)
                                .finish()
                        }
    ...
    pub mod wacli {
        pub mod cli {
            ...
            pub mod host_env {
                ...
                pub unsafe fn _export_args_cabi<T: Guest>() -> *mut u8 {
                    unsafe {
                ...
                pub unsafe fn __post_return_args<T: Guest>(arg0: *mut u8) {
                    unsafe {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_env_cabi<T: Guest>() -> *mut u8 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        let result0 = { T::env() };
                        let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
                        let vec5 = result0;
                        let len5 = vec5.len();
                        let layout5 = _rt::alloc::Layout::from_size_align(
                                vec5.len() * (4 * ::core::mem::size_of::<*const u8>()),
                                ::core::mem::size_of::<*const u8>(),
                            )
                            .unwrap();
                        let (result5, _cleanup5) = wit_bindgen::rt::Cleanup::new(
                            layout5,
                        );
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_env<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = *arg0.add(0).cast::<*mut u8>();
                        let l1 = *arg0
                            .add(::core::mem::size_of::<*const u8>())
                ...
                macro_rules! __export_wacli_cli_host_env_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "wacli:cli/host-env@2.0.0#args")] unsafe extern "C" fn
                        export_args() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_args_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-env@2.0.0#args")] unsafe extern "C" fn
                        _post_return_args(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_args::<$ty > (arg0) } }
                        #[unsafe (export_name = "wacli:cli/host-env@2.0.0#env")] unsafe
                        extern "C" fn export_env() -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_env_cabi::<$ty > () } } #[unsafe
                        (export_name = "cabi_post_wacli:cli/host-env@2.0.0#env")] unsafe
                        extern "C" fn _post_return_env(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_env::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
            ...
            pub mod host_io {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_stdout_write_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        {
                            ...
                            T::stdout_write(
                                <_ as From<
                                    _rt::Vec<_>,
                                >>::from(_rt::Vec::from_raw_parts(arg0.cast(), len0, len0)),
                            )
                        };
                    }
                }
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_stderr_write_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) {
                    unsafe {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_stdout_flush_cabi<T: Guest>() {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        { T::stdout_flush() };
                    }
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_stderr_flush_cabi<T: Guest>() {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        { T::stderr_flush() };
                    }
                ...
                macro_rules! __export_wacli_cli_host_io_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wacli:cli/host-io@2.0.0#stdout-write")] unsafe extern "C" fn
                        export_stdout_write(arg0 : * mut u8, arg1 : usize,) { unsafe {
                        $($path_to_types)*:: _export_stdout_write_cabi::<$ty > (arg0,
                        arg1) } } #[unsafe (export_name =
                        "wacli:cli/host-io@2.0.0#stderr-write")] unsafe extern "C" fn
                        export_stderr_write(arg0 : * mut u8, arg1 : usize,) { unsafe {
                        $($path_to_types)*:: _export_stderr_write_cabi::<$ty > (arg0,
                        arg1) } } #[unsafe (export_name =
                        "wacli:cli/host-io@2.0.0#stdout-flush")] unsafe extern "C" fn
                        export_stdout_flush() { unsafe { $($path_to_types)*::
                        _export_stdout_flush_cabi::<$ty > () } } #[unsafe (export_name =
                        "wacli:cli/host-io@2.0.0#stderr-flush")] unsafe extern "C" fn
                        export_stderr_flush() { unsafe { $($path_to_types)*::
                        _export_stderr_flush_cabi::<$ty > () } } };
                    };
                }
                #[doc(hidden)]
            ...
            pub mod host_fs {
                        ...
                        match result1 {
                            Ok(e) => {
                                *ptr2.add(0).cast::<u8>() = (0i32) as u8;
                                let vec3 = <_ as Into<_rt::Vec<_>>>::into(e)
                                    .into_boxed_slice();
                                let ptr3 = vec3.as_ptr().cast::<u8>();
                                let len3 = vec3.len();
                                ::core::mem::forget(vec3);
                    ...
                    unsafe {
                        ...
                        let result2 = {
                            ...
                            T::write_file(
                                ...
                                <_ as From<
                                    _rt::Vec<_>,
                                >>::from(_rt::Vec::from_raw_parts(arg2.cast(), len1, len1)),
                            )
                        };
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_create_dir_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    unsafe {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_create_dir<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = i32::from(*arg0.add(0).cast::<u8>());
                        match l0 {
                            0 => {}
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_list_dir_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    unsafe {
                            ...
                            Ok(e) => {
                                *ptr2.add(0).cast::<u8>() = (0i32) as u8;
                                ...
                                let layout4 = _rt::alloc::Layout::from_size_align(
                                    ...
                                    .unwrap();
                                let (result4, _cleanup4) = wit_bindgen::rt::Cleanup::new(
                                    layout4,
                                );
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_list_dir<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = i32::from(*arg0.add(0).cast::<u8>());
                        match l0 {
                            0 => {
                ...
                macro_rules! __export_wacli_cli_host_fs_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wacli:cli/host-fs@2.0.0#read-file")] unsafe extern "C" fn
                        export_read_file(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        unsafe { $($path_to_types)*:: _export_read_file_cabi::<$ty >
                        (arg0, arg1) } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-fs@2.0.0#read-file")] unsafe extern "C"
                        fn _post_return_read_file(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_read_file::<$ty > (arg0) } }
                        #[unsafe (export_name = "wacli:cli/host-fs@2.0.0#write-file")]
                        unsafe extern "C" fn export_write_file(arg0 : * mut u8, arg1 :
                        usize, arg2 : * mut u8, arg3 : usize,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_write_file_cabi::<$ty > (arg0, arg1,
                        arg2, arg3) } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-fs@2.0.0#write-file")] unsafe extern
                        "C" fn _post_return_write_file(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_write_file::<$ty > (arg0) } }
                        #[unsafe (export_name = "wacli:cli/host-fs@2.0.0#create-dir")]
                        unsafe extern "C" fn export_create_dir(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_create_dir_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name = "cabi_post_wacli:cli/host-fs@2.0.0#create-dir")]
                        unsafe extern "C" fn _post_return_create_dir(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_create_dir::<$ty >
                        (arg0) } } #[unsafe (export_name =
                        "wacli:cli/host-fs@2.0.0#list-dir")] unsafe extern "C" fn
                        export_list_dir(arg0 : * mut u8, arg1 : usize,) -> * mut u8 {
                        unsafe { $($path_to_types)*:: _export_list_dir_cabi::<$ty >
                        (arg0, arg1) } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-fs@2.0.0#list-dir")] unsafe extern "C"
                        fn _post_return_list_dir(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_list_dir::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
            ...
            pub mod host_process {
                ...
                macro_rules! __export_wacli_cli_host_process_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wacli:cli/host-process@2.0.0#exit")] unsafe extern "C" fn
            ...
            pub mod host_pipes {
                ...
                impl Pipe {
                    ...
                    pub fn new<T: GuestPipe>(val: T) -> Self {
                        ...
                        let ptr: *mut _PipeRep<T> = _rt::Box::into_raw(
                            _rt::Box::new(val),
                        );
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = unsafe {
                            _rt::Box::from_raw(handle as *mut _PipeRep<T>)
                        };
                    }
                ...
                unsafe impl _rt::WasmResource for Pipe {
                    ...
                    unsafe fn drop(_handle: u32) {
                        #[cfg(target_arch = "wasm32")]
                        #[link(
                            wasm_import_module = "[export]wacli:cli/host-pipes@2.0.0"
                        )]
                        unsafe extern "C" {
                            #[link_name = "[resource-drop]pipe"]
                            fn drop(_: i32);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_list_pipes_cabi<T: Guest>() -> *mut u8 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        let result0 = { T::list_pipes() };
                        let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
                        let vec6 = result0;
                        let len6 = vec6.len();
                        ...
                        for (i, e) in vec6.into_iter().enumerate() {
                            let base = result6
                                .add(i * (6 * ::core::mem::size_of::<*const u8>()));
                            {
                                let super::super::super::super::exports::wacli::cli::types::PipeInfo {
                                    name: name2,
                                    summary: summary2,
                                    path: path2,
                                } = e;
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_list_pipes<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = *arg0.add(0).cast::<*mut u8>();
                        let l1 = *arg0
                            .add(::core::mem::size_of::<*const u8>())
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_load_pipe_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    unsafe {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_load_pipe<T: Guest>(arg0: *mut u8) {
                    unsafe {
                        let l0 = i32::from(*arg0.add(0).cast::<u8>());
                        match l0 {
                            0 => {}
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_method_pipe_meta_cabi<T: GuestPipe>(
                    arg0: *mut u8,
                ) -> *mut u8 {
                    unsafe {
                        #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                        ...
                        let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
                        let super::super::super::super::exports::wacli::cli::types::PipeMeta {
                            name: name2,
                            summary: summary2,
                            input_types: input_types2,
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_pipe_meta<T: GuestPipe>(
                    arg0: *mut u8,
                ) {
                    unsafe {
                        let l0 = *arg0.add(0).cast::<*mut u8>();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case, unused_unsafe)]
                pub unsafe fn _export_method_pipe_process_cabi<T: GuestPipe>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: *mut u8,
                    ...
                    unsafe {
                        ...
                        let result5 = {
                            ...
                            T::process(
                                PipeBorrow::lift(arg0 as u32 as usize).get(),
                                <_ as From<
                                    _rt::Vec<_>,
                                >>::from(_rt::Vec::from_raw_parts(arg1.cast(), len0, len0)),
                                result4,
                            )
                        };
                        ...
                        match result5 {
                            Ok(e) => {
                                *ptr6.add(0).cast::<u8>() = (0i32) as u8;
                                let vec7 = <_ as Into<_rt::Vec<_>>>::into(e)
                                    .into_boxed_slice();
                                let ptr7 = vec7.as_ptr().cast::<u8>();
                                let len7 = vec7.len();
                                ::core::mem::forget(vec7);
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_method_pipe_process<T: GuestPipe>(
                    arg0: *mut u8,
                ) {
                    unsafe {
                        let l0 = i32::from(*arg0.add(0).cast::<u8>());
                ...
                macro_rules! __export_wacli_cli_host_pipes_2_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wacli:cli/host-pipes@2.0.0#list-pipes")] unsafe extern "C" fn
                        export_list_pipes() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_list_pipes_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-pipes@2.0.0#list-pipes")] unsafe extern
                        "C" fn _post_return_list_pipes(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_list_pipes::<$ty > (arg0) } }
                        #[unsafe (export_name = "wacli:cli/host-pipes@2.0.0#load-pipe")]
                        unsafe extern "C" fn export_load_pipe(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_load_pipe_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name = "cabi_post_wacli:cli/host-pipes@2.0.0#load-pipe")]
                        unsafe extern "C" fn _post_return_load_pipe(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_load_pipe::<$ty >
                        (arg0) } } #[unsafe (export_name =
                        "wacli:cli/host-pipes@2.0.0#[method]pipe.meta")] unsafe extern
                        "C" fn export_method_pipe_meta(arg0 : * mut u8,) -> * mut u8 {
                        unsafe { $($path_to_types)*::
                        _export_method_pipe_meta_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Pipe > (arg0) } } #[unsafe (export_name =
                        "cabi_post_wacli:cli/host-pipes@2.0.0#[method]pipe.meta")] unsafe
                        extern "C" fn _post_return_method_pipe_meta(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*::
                        __post_return_method_pipe_meta::<<$ty as $($path_to_types)*::
                        Guest >::Pipe > (arg0) } } #[unsafe (export_name =
                        "wacli:cli/host-pipes@2.0.0#[method]pipe.process")] unsafe extern
                        "C" fn export_method_pipe_process(arg0 : * mut u8, arg1 : * mut
                        u8, arg2 : usize, arg3 : * mut u8, arg4 : usize,) -> * mut u8 {
                        unsafe { $($path_to_types)*::
                        _export_method_pipe_process_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Pipe > (arg0, arg1, arg2, arg3, arg4) } } #[unsafe
                        (export_name =
                        "cabi_post_wacli:cli/host-pipes@2.0.0#[method]pipe.process")]
                        unsafe extern "C" fn _post_return_method_pipe_process(arg0 : *
                        mut u8,) { unsafe { $($path_to_types)*::
                        __post_return_method_pipe_process::<<$ty as $($path_to_types)*::
                        Guest >::Pipe > (arg0) } } const _ : () = { #[doc(hidden)]
                        #[unsafe (export_name = "wacli:cli/host-pipes@2.0.0#[dtor]pipe")]
                        #[allow(non_snake_case)] unsafe extern "C" fn dtor(rep : * mut
                        u8) { unsafe { $($path_to_types)*:: Pipe::dtor::< <$ty as
                        $($path_to_types)*:: Guest >::Pipe > (rep) } } }; };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_host_provider_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wacli::cli::types::__export_wacli_cli_types_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::types);
        $($path_to_types_root)*::
        exports::wacli::cli::host_env::__export_wacli_cli_host_env_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::host_env);
        $($path_to_types_root)*::
        exports::wacli::cli::host_io::__export_wacli_cli_host_io_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::host_io);
        $($path_to_types_root)*::
        exports::wacli::cli::host_fs::__export_wacli_cli_host_fs_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::host_fs);
        $($path_to_types_root)*::
        exports::wacli::cli::host_process::__export_wacli_cli_host_process_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::host_process);
        $($path_to_types_root)*::
        exports::wacli::cli::host_pipes::__export_wacli_cli_host_pipes_2_0_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wacli::cli::host_pipes);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.52.0:wacli:cli@2.0.0:host-provider:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7059] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8f6\x01A\x02\x01A/\x01\
...
\x01ps\x01@\0\0\0\x04\0\x04args\x01\x01\x01o\x02ss\x01p\x02\x01@\0\0\x03\x04\0\x03\
env\x01\x04\x04\0\x18wacli:cli/host-env@2.0.0\x05\x17\x01B\x07\x01p}\x01@\x01\x05\
bytes\0\x01\0\x04\0\x0cstdout-write\x01\x01\x04\0\x0cstderr-write\x01\x01\x01@\0\
\x01\0\x04\0\x0cstdout-flush\x01\x02\x04\0\x0cstderr-flush\x01\x02\x04\0\x17wacl\
i:cli/host-io@2.0.0\x05\x18\x01B\x0d\x01p}\x01j\x01\0\x01s\x01@\x01\x04paths\0\x01\
\x04\0\x09read-file\x01\x02\x01j\0\x01s\x01@\x02\x04paths\x08contents\0\0\x03\x04\
\0\x0awrite-file\x01\x04\x01@\x01\x04paths\0\x03\x04\0\x0acreate-dir\x01\x05\x01\
ps\x01j\x01\x06\x01s\x01@\x01\x04paths\0\x07\x04\0\x08list-dir\x01\x08\x04\0\x17\
wacli:cli/host-fs@2.0.0\x05\x19\x02\x03\0\x0c\x09exit-code\x01B\x04\x02\x03\x02\x01\
\x1a\x04\0\x09exit-code\x03\0\0\x01@\x01\x04code\x01\x01\0\x04\0\x04exit\x01\x02\
\x04\0\x1cwacli:cli/host-process@2.0.0\x05\x1b\x01B\x16\x02\x03\x02\x01\x01\x04\0\
\x09pipe-meta\x03\0\0\x02\x03\x02\x01\x02\x04\0\x0apipe-error\x03\0\x02\x02\x03\x02\
\x01\x03\x04\0\x09pipe-info\x03\0\x04\x04\0\x04pipe\x03\x01\x01h\x06\x01@\x01\x04\
self\x07\0\x01\x04\0\x11[method]pipe.meta\x01\x08\x01p}\x01ps\x01j\x01\x09\x01\x03\
\x01@\x03\x04self\x07\x05input\x09\x07options\x0a\0\x0b\x04\0\x14[method]pipe.pr\
ocess\x01\x0c\x01p\x05\x01@\0\0\x0d\x04\0\x0alist-pipes\x01\x0e\x01i\x06\x01j\x01\
\x0f\x01s\x01@\x01\x04names\0\x10\x04\0\x09load-pipe\x01\x11\x04\0\x1awacli:cli/\
host-pipes@2.0.0\x05\x1c\x04\0\x1dwacli:cli/host-provider@2.0.0\x04\0\x0b\x13\x01\
\0\x0dhost-provider\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compo\
nent\x070.244.0\x10wit-bindgen-rust\x060.52.0";
#[inline(never)]
#[doc(hidden)]
