        ...
        pub mod registry {
            ...
            pub fn list_commands() -> _rt::Vec<CommandMeta> {
                unsafe {
                    ...
                    for i in 0..len59 {
                        let base = base59
                            .add(i * (17 * ::core::mem::size_of::<*const u8>()));
                        let e59 = {
                            let l4 = *base.add(0).cast::<*mut u8>();
                            let l5 = *base
                                .add(::core::mem::size_of::<*const u8>())
                            ...
                            _rt::cabi_dealloc(
                                base58,
                                len58 * (18 * ::core::mem::size_of::<*const u8>()),
                                ::core::mem::size_of::<*const u8>(),
                            );
                    ...
                    _rt::cabi_dealloc(
                        base59,
                        len59 * (17 * ::core::mem::size_of::<*const u8>()),
                        ::core::mem::size_of::<*const u8>(),
                    );
            ...
            pub fn run(name: &str, argv: &[_rt::String]) -> CommandResult {
                unsafe {
                    ...
                    let layout2 = _rt::alloc::Layout::from_size_align(
                        ...
                        .unwrap();
                    let (result2, _cleanup2) = wit_bindgen::rt::Cleanup::new(layout2);
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.52.0:wacli:cli@2.0.0:core:encoded world"
)]
#[doc(hidden)]
...
run\x01\x07\x03\0\x18wacli:cli/registry@2.0.0\x05\x07\x01B\x03\x01j\0\0\x01@\0\0\
\0\x04\0\x03run\x01\x01\x04\0\x12wasi:cli/run@0.2.9\x05\x08\x04\0\x14wacli:cli/c\
ore@2.0.0\x04\0\x0b\x0a\x01\0\x04core\x03\0\0\0G\x09producers\x01\x0cprocessed-b\
y\x02\x0dwit-component\x070.244.0\x10wit-bindgen-rust\x060.52.0";
#[inline(never)]
#[doc(hidden)]
